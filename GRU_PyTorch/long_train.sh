...
lastmodel=`ls -1 gru_mae_simple_b1_h48-8_14_*`
python train_pahm.py --epochs 750 --loss_type mse --batch_size 1 --hidden_size [48,8] --model_name gru_mse_simple_b1_h48-8_15 --wandb_run gru_mse_simple_b1_h48-8_15 --load_model $lastmodel
lastmodel=`ls -1 gru_mse_simple_b1_h48-8_15_*`
python train_pahm.py --epochs 1500 --loss_type mae --batch_size 1 --hidden_size [48,8] --model_name gru_mae_simple_b1_h48-8_15 --wandb_run gru_mae_simple_b1_h48-8_15 --load_model $lastmodel
