...
\begin{document}
  ...
  %\include{acta_aprob_licel}  % Remover en versión final
  \includepdf[width=1.4\textwidth, offset=0.75in -1.00in]{actas/acta_aprob_firmada} % Incluir el acta firmada acá.
  ...
  %\include{acta_eval_licel}   % >> Remover en versión final <<
  %\includepdf{actas/acta_aprob_firmada}
    
  %% Para la maestría en electrónica:
  %\include{acta_aprob_mscel}  % Remover en versión final
  %\include{acta_eval_mscel}   % Remover en versión final
  %% -------------------------------------------------
  \include{resumen}
  \include{dedicatoria}
