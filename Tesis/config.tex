...
%
\defAuthor[M]{Juan Pérez Prado}                % Nombre del estudiante
%\defAuthor[f]{María del Pilar Pérez Prado}    % Nombre de la estudiante

\defAuthorShort{J.~Pérez}                      % Nombre corto
\defAuthorTECID{201412345}                     % Carné
...
\defTitle{Diseño de un aparato que produce energía infinita \\%
  y elimina el cambio climático \\%
  por medio del uso de circuitos analógicos \\%
  controlados por una arquitectura RISC V}
